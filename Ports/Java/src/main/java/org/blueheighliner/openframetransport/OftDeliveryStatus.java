 ...
 * preempts (see Docs/OFT.md &sect;6) - a single-packet send can never be interrupted, since there is
...
public enum OftDeliveryStatus {
    ...
    /**
     * A higher-priority send has preempted this one before it finished (see Docs/OFT.md &sect;6); it
    ...
    /**
     * The send's final packet has been acknowledged (a {@code Receipt} - see Docs/OFT.md
    ...
    /**
     * The send was cancelled (see Docs/OFT.md &sect;7) before its final packet was written. This is
