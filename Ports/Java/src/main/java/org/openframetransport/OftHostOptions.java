...
public final class OftHostOptions {
     ...
     * {@link OftSecurityMode#AUTHENTICATION} and {@link OftSecurityMode#DUAL_AUTHENTICATION}; unused
     * under {@link OftSecurityMode#SECURE} (an internally generated certificate is used instead) and
     * {@link OftSecurityMode#INSECURE} (which never negotiates TLS at all).
     */
     ...
     * {@link #securityMode()} is {@link OftSecurityMode#INSECURE}.
     */
