...
final class InsecureModeTest {
    @Test
    void insecure_connectionEstablishesAndExchangesMessages() throws Exception {
        try (OftTestHarness.Pair pair = OftTestHarness.establish(16384, null, OftSecurityMode.INSECURE, Duration.ofSeconds(1), Duration.ofSeconds(5))) {
    ...
    @Test
    void host_authenticationModeWithoutSslContext_throws() {
    ...
    @Test
    void host_insecureWithoutSslContext_succeeds() throws Exception {
        OftHostOptions options = OftHostOptions.builder()
                .info("server")
    ...
    @Test
    void rekey_onInsecureConnection_isNoOp() throws Exception {
        try (OftTestHarness.Pair pair = OftTestHarness.establish(16384, null, OftSecurityMode.INSECURE, Duration.ofSeconds(1), Duration.ofSeconds(5))) {
    ...
    @Test
    void insecure_hailIsExchangedDirectlyOverRawTcp() throws Exception {
